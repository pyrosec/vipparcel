...
export class VIPParcel {
  ...
  async shippingScanFormGetLabels(o: any) {
    const body = { ...o };
  ...
  async accountPersonalInfoDetails(o: any) {
    const body = { ...o };
  ...
  async locationCountryGetList(o: any) {
    const body = { ...o };
    return await this._call("/location/country/getList", { method: "GET" });
  }
  async locationStateGetList(o: { military: boolean }) {
    const body = { ...o };
