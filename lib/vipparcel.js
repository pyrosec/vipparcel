...
class VIPParcel {
    ...
    async ipinfo() {
        return await (await (0, node_fetch_1.default)('https://ipinfo.io/json', { agent: this._makeAgent(), method: 'GET' })).text();
    }
    ...
    async shippingRefundRequest(o) {
        if (typeof o.refundLabels === 'string')
            o.refundLabels = o.refundLabels.split(',');
